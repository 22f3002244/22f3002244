...
**AI Developer Intern — Ubiqedge Technologies** `Sep 2025 – Apr 2026`  
Built a Groq-powered LLM pipeline that converts raw IoT telemetry into natural-language dashboards. Designed a 4-stage data processing architecture (ingestion → validation → chart selection → dashboard gen). Reduced manual analysis time by ~40%.
...
<sub>Open to backend, AI/ML, and full-stack roles. Reach me at vedantkonde09@gmail.com</sub>
